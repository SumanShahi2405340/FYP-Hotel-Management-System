...
const ROOMS = [
  {
    src: 'https://images.unsplash.com/photo-1618773928121-c32242e63f39?w=900&auto=format&fit=crop',
    name: 'Deluxe Suite',
    desc: 'King bed · Ocean view · 68 m²',
    tag: 'Available',
  },
  {
    src: 'https://images.unsplash.com/photo-1564501049412-61c2a3083791?w=900&auto=format&fit=crop',
    name: 'Presidential Suite',
    desc: 'Two bedrooms · Private terrace · 142 m²',
    tag: 'Featured',
  },
  {
    src: 'https://images.unsplash.com/photo-1605346434674-a440ca4dc4c0?w=900&auto=format&fit=crop',
    name: 'Classic Double',
    desc: 'Twin or double · Garden view · 32 m²',
    tag: 'Available',
  },
];
      ...
      <style>{`
        ...
        *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
        ...
        :root {
          ...
          --ivory-14:    rgba(244,239,229,0.14);
        }
        ...
        .nav-btn {
          ...
          color: var(--ivory-60); font-family: 'Outfit', sans-serif;
          font-size: 0.7rem; font-weight: 500; letter-spacing: 0.1em;
          text-transform: uppercase; cursor: pointer; padding: 0.4rem 0.9rem;
        ...
        .hero-bg {
          ...
          background-image: url('https://images.unsplash.com/photo-1542314831-068cd1dbfeeb?w=1800&auto=format&fit=crop');
          background-size: cover; background-position: center 40%; z-index: 0;
        }
        .hero-overlay {
          position: absolute; inset: 0; z-index: 1;
          background:
            radial-gradient(ellipse 70% 55% at 50% 110%, rgba(8,7,6,0.97) 20%, transparent 100%),
            radial-gradient(ellipse 100% 40% at 50% 0%,  rgba(8,7,6,0.78) 0%,  transparent 100%),
            linear-gradient(180deg, rgba(8,7,6,0.48) 0%, rgba(8,7,6,0.1) 42%, rgba(8,7,6,0.6) 100%);
        }
        .hero-grain {
        ...
        .hero-content { position: relative; z-index: 10; text-align: center; width: 100%; max-width: 860px; }

        .hero-eyebrow {
          display: inline-flex; align-items: center; gap: 0.7rem;
          font-size: 0.62rem; font-weight: 600; letter-spacing: 0.44em;
          color: var(--gold); text-transform: uppercase; margin-bottom: 1.3rem;
        ...
        .hero-sub {
          font-size: 0.8rem; font-weight: 400; letter-spacing: 0.2em;
          text-transform: uppercase; color: var(--ivory-30);
        ...
        .ornament {
          ...
          margin-bottom: 3.5rem; animation: fadeUp 0.8s ease 0.58s both;
        }
        ...
        .role-card::after {
          ...
          background: radial-gradient(ellipse 80% 50% at 50% 0%, rgba(200,169,110,0.08), transparent 70%);
          opacity: 0; transition: opacity 0.35s;
        }
        ...
        .role-card:hover .rc-icon-wrap, .role-card.active .rc-icon-wrap {
          transform: scale(1.1);
          border-color: rgba(200,169,110,0.48);
          background: rgba(200,169,110,0.16);
        }
        .role-card.active .rc-icon-wrap::after {
        ...
        .rc-label {
          font-family: 'Cormorant', serif; font-size: 1.55rem; font-weight: 500;
          color: var(--ivory); letter-spacing: 0.02em; margin-bottom: 0.4rem;
        ...
        .rc-cta {
          ...
          margin-top: 1.35rem; font-size: 0.6rem; font-weight: 600;
        ...
        .scroll-arrow {
          width: 1px; height: 36px; background: linear-gradient(180deg, var(--gold) 0%, transparent 100%);
        ...
        .section-body {
          font-size: 0.9rem; font-weight: 300; line-height: 1.88;
          color: var(--ivory-60); max-width: 480px;
        }
        ...
        .gal-overlay {
          position: absolute; inset: 0;
          background: linear-gradient(180deg, transparent 55%, rgba(8,7,6,0.72) 100%);
        ...
        .stat-num {
          font-family: 'Cormorant', serif; font-size: 3.2rem; font-weight: 300;
          color: var(--gold-lt); letter-spacing: 0.02em; line-height: 1; margin-bottom: 0.5rem;
        }
        .stat-label {
        ...
        .room-card {
          ...
          background: var(--ink-3); border: 1px solid var(--gold-border);
        ...
        .room-tag {
          ...
          background: rgba(8,7,6,0.72); backdrop-filter: blur(8px);
          border: 1px solid var(--gold-border); border-radius: 1px;
        ...
        .room-name {
          font-family: 'Cormorant', serif; font-size: 1.3rem; font-weight: 500;
          color: var(--ivory); margin-bottom: 0.35rem; letter-spacing: 0.01em;
        }
        ...
        .feat-icon {
          ...
          background: var(--gold-dim); transition: background 0.3s, border-color 0.3s;
        }
        .feat-icon svg { width: 22px; height: 22px; }
        .feat-card:hover .feat-icon { background: rgba(200,169,110,0.22); border-color: rgba(200,169,110,0.4); }

        .feat-name {
          font-family: 'Cormorant', serif; font-size: 1.22rem; font-weight: 500;
          color: var(--ivory); margin-bottom: 0.55rem;
        }
        ...
        .footer-top {
          ...
          flex-wrap: wrap; gap: 2.5rem; padding-bottom: 2.5rem;
                    border-bottom: 1px solid var(--gold-border);
          margin-bottom: 1.8rem;
        }
        .footer-brand p {
          font-size: 0.8rem; font-weight: 300; line-height: 1.75;
          color: var(--ivory-30); max-width: 250px; margin-top: 0.8rem;
        }
        .footer-col h4 {
        ...
        .footer-col button {
          ...
          font-size: 0.8rem; font-weight: 300; color: var(--ivory-60);
          cursor: pointer; transition: color 0.2s; font-family: 'Outfit', sans-serif;
        }
        ...
        @media (max-width: 960px) {
          ...
          .gal-item:nth-child(5) { grid-column: auto; grid-row: auto; min-height: 200px; }
        ...
        <section className="hero" id="hero">
          ...
          <div className="hero-content">
            <p className="hero-eyebrow">
              ...
              CloudInn Hotel System
              <span className="eyebrow-dash" />
            </p>
            <h1 className="hero-h1">
              Manage Every Moment<br />of a <em>Perfect Stay</em>
            </h1>
          ...
          <div className="section-inner">
            <div className="rooms-header">
              <div data-reveal>
                ...
                <h2 className="section-h2">Rooms <em>Crafted</em><br />for Every Guest</h2>
              </div>
              <p className="section-body" data-reveal="right">
                From intimate classic doubles to expansive presidential suites — every room is managed with precision. Availability, housekeeping, and billing unified in one elegant dashboard.
              </p>
            </div>
          ...
          <div className="section-inner">
            <div className="features-header">
              <div data-reveal>
                ...
                <h2 className="section-h2">Everything Under<br />One <em>Intelligent</em> Roof</h2>
              </div>
              <p className="section-body" data-reveal="right">
                CloudInn brings every corner of hotel operations into a single, cohesive platform — so your team spends less time switching tools and more time delighting guests.
              </p>
            </div>
