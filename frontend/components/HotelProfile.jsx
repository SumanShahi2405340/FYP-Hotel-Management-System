...
import { 
  ...
  FaSpinner, FaTimes, FaDirections, FaCopy, FaCheck, FaBed, FaHotel,
  FaChevronCircleLeft, FaChevronCircleRight, FaPause, FaPlay
} from 'react-icons/fa';
...
export default function HotelProfile() {
  ...
  // Fetch rooms and their images from RoomImage API
  const fetchRoomsData = async () => {
    try {
      ...
      // Create one room per type (first available)
      const roomsList = [];
  ...
  const getFormattedLocation = () => {
    ...
    const l = hotel.location || '', n = hotel.name || '';
    if (l && n) return `${l}, ${n}`;
    return l || n || 'Location not available';
  };
              ...
              <div className="max-w-6xl mx-auto">
                ...
                <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
                  <div className="lg:col-span-2 space-y-8">
                      ...
                      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                        ...
                        <div className="flex items-center gap-3">
                          ...
                          <div>
                            ...
                            <p className="text-white font-medium">{formattedLocation}</p>
                          </div>
                        </div>
                      </div>
                    ...
                    {/* Rooms Section - One per type with carousel */}
                  ...
                  <div className="space-y-8">
                    ...
                    <div className="glass-card rounded-2xl p-6 fade-up" style={{animationDelay:'0.25s',opacity:0}}>
                      ...
                      <div className="mt-3 space-y-1">
                        <p className="text-xs text-amber-400/60">✓ Click "Get Directions" to navigate here</p>
                        <p className="text-xs text-amber-400/60">✓ Click "Copy Location" to copy the address</p>
                      </div>
                    </div>
                  </div>
                </div>
          ...
          <div className="bg-gradient-to-br from-gray-900 to-gray-800 rounded-2xl max-w-md w-full mx-4 shadow-2xl border border-amber-500/30">
            <div className="p-6">
              <div className="flex justify-between items-center mb-4">
                <h3 className="text-xl font-bold text-white flex items-center gap-2"><FaRoute className="text-amber-400"/> Directions to {hotel?.name}</h3>
              ...
              {locationError?(
                ...
                <div className="space-y-4">
                  ...
                  <div className="bg-amber-500/10 border border-amber-500/30 rounded-lg p-4">
                    <p className="text-amber-400 text-sm">Destination: {hotel?.name}</p>
                    <p className="text-gray-300 text-xs mt-1 font-mono">{formattedLocation}</p>
                  </div>
