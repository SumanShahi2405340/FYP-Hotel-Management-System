      ...
      <div className="p-6 max-w-6xl mx-auto bg-white/10 backdrop-blur-md rounded-xl shadow-xl">
        ...
        <div className="bg-gray-900 p-6 rounded-lg shadow-md space-y-2 text-white">
          ...
          <div className="flex items-center gap-4">
            ...
            <button
              onClick={() => router.push(`/admin/owner-profile/${hotel.id}`)}
...
//         // Once hotel is registered, load dummy images
//         setHotelImages([
//           '/admindash1.jpg',     
//           '/register.jpg',  
//           '/hprofile3.jpg',  // dummy images from public folder
//         ]);
...
//   // Example performance data (replace with API if available)
//   const performanceData = {
//     '2025': {
//       Jan: [3, 4, 5], Feb: [4, 3, 5], Mar: [5, 4, 4],
//     },
