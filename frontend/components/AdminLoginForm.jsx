  ...
  return (
    <div className="min-h-screen flex items-center justify-center relative overflow-hidden bg-black">
      ...
      <div className="absolute inset-0 z-0">
        ...
        {/* Abstract pattern image (replace with your own or keep as texture) */}
        <div 
      ...
      <div className="relative z-20 w-full max-w-md mx-4">
        ...
        <div className="bg-white/5 backdrop-blur-xl rounded-2xl shadow-2xl p-8 border border-white/10 hover:border-amber-500/30 transition-all duration-500">
          ...
          <div className="flex flex-col items-center mb-8">
            ...
            <p className="text-sm text-gray-400 mt-1">Administrator Access</p>
          ...
          <div className="space-y-4">
            <div className="group">
              ...
              <input
                type="email"
                placeholder="admin@cloudinn.com"
                value={email}
          ...
          <div className="mt-8 pt-6 border-t border-white/10 text-center">
            <p className="text-xs text-gray-500">
              Secure admin portal • Protected by CloudInn
            </p>
          </div>
        </div>
      ...
      {/* Animation keyframes (add to your global CSS or use Tailwind config) */}
      <style jsx>{`
        @keyframes float {
