...
const OwnerDashboard = () => {
  ...
  const [ownerannouncementOpen, setOwnerAnnouncementOpen] = useState(false);
  ...
  return (
    <div className="min-h-screen flex">
      ...
      >
        ...
        {/* Sidebar buttons */}
        <button onClick={() => setOwnerAnnouncementOpen(!ownerannouncementOpen)}
      ...
      <div className={`flex-1 p-5 transition-all duration-300 ${sidebarOpen ? "ml-64" : "ml-0"}`}>
        ...
        {view === "checkincheckout" && <ViewCheckinCheckout />}
          ...
          <OwnerAnnouncementPanel
            isOpen={ownerannouncementOpen}
            onClose={() => setOwnerAnnouncementOpen(false)}
          />
      </div>
    </div>
  );
